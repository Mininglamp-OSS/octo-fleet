...
func TestIsAllowedGatewayURL(t *testing.T) {
	tests := []struct {
		...
		{"https localhost rejected", "https://localhost", false},
		{"https ipv6 loopback rejected", "https://[::1]", false},
		{"https ipv6 ula rejected", "https://[fd00::1]", false},
		{"https v4-mapped private rejected", "https://[::ffff:10.0.0.1]", false},
		{"https unspecified rejected", "https://0.0.0.0", false},
		{"https cgnat rejected", "https://100.64.0.1", false},
		{"https public ipv6 allowed", "https://[2606:4700::1111]", true},
